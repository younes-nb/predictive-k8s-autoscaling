...
def main() -> None:
    ap = argparse.ArgumentParser(description="CSHVTB end-to-end pipeline")
    ...
    if not args.skip_preprocess:
        ...
        label = "Step 1 — CEEMDAN-SE-HDBSCAN-VMD Decomposition"
    ...
    if not args.skip_train:
        ...
        run_step(train_cmd, "Step 2 — Train CSHVTB Model (TCN + BiGRU)")
    ...
    if not args.skip_eval:
        ...
        if args.cpu:
            eval_cmd.append("--cpu")
        run_step(eval_cmd, "Step 3 — Evaluate CSHVTB")

    print("\n" + "=" * 60)
    print("=== CSHVTB Pipeline Complete ===")
    print("=" * 60)
