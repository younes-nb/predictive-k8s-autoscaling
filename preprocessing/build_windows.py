...
_CSV_COLUMN_MAP = {
    ...
    "net_rx": "net_rx",
    "rps_total": "rps_total",
    "caller_rps_max": "caller_rps_max",
    "upstream_rps_sum": "upstream_rps_sum",
    "root_rps": "root_rps",
    "rps_z30": "rps_z30",
    "rps_slope5": "rps_slope5",
    "ewma_gap": "ewma_gap",
    ...
    "n_callers": "n_callers",
    "req_byte_rate": "req_byte_rate",
    "resp_byte_rate": "resp_byte_rate",
    "req_bytes_per_req": "req_bytes_per_req",
    "resp_bytes_per_req": "resp_bytes_per_req",
    "slow_frac": "slow_frac",
    "req_msg_rate": "req_msg_rate",
    "resp_msg_rate": "resp_msg_rate",
    "msgs_per_req": "msgs_per_req",
    "err_rate": "err_rate",
    "err_frac": "err_frac",
    "flag_rate": "flag_rate",
    "flag_frac": "flag_frac",
    ...
    "tod_sin": "tod_sin",
    "tod_cos": "tod_cos",
    "neigh_cpu_mean": "neigh_cpu_mean",
    "neigh_cpu_slope3": "neigh_cpu_slope3",
    "neigh_rps_z30_mean": "neigh_rps_z30_mean",
    "neigh_rps_slope5_mean": "neigh_rps_slope5_mean",
