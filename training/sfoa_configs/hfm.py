SEARCH_SPACE = [
    {"name": "hfm_dropout", "type": "continuous", "low": 0.1, "high": 0.5},
...
def build_model(hyperparams, input_size, args, num_targets, device):
    from core.architectures.hfm import HierarchicalFrequencyMixer
    ...
    return HierarchicalFrequencyMixer(
        ...
        dropout=hyperparams["hfm_dropout"],
    ).to(device)
